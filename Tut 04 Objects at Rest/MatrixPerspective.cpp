...
const float vertexData[] = {
    ...
    -0.25f, -0.25f, -1.25f, 1.0f,
    -0.25f, -0.25f, -2.75f, 1.0f,
    -0.25f, 0.25f,  -1.25f, 1.0f,   -0.25f, -0.25f,
    -2.75f, 1.0f,   -0.25f, 0.25f,  -2.75f, 1.0f,

    0.25f,  0.25f,  -1.25f, 1.0f,   0.25f,  -0.25f,
    -2.75f, 1.0f,   0.25f,  -0.25f, -1.25f, 1.0f,

    0.25f,  0.25f,  -1.25f, 1.0f,   0.25f,  0.25f,
    -2.75f, 1.0f,   0.25f,  -0.25f, -2.75f, 1.0f,

    0.25f,  0.25f,  -2.75f, 1.0f,   0.25f,  0.25f,
    -1.25f, 1.0f,   -0.25f, 0.25f,  -1.25f, 1.0f,

    0.25f,  0.25f,  -2.75f, 1.0f,   -0.25f, 0.25f,
    -1.25f, 1.0f,   -0.25f, 0.25f,  -2.75f, 1.0f,
    ...
    0.8f,   0.8f,   0.8f,   1.0f,   0.8f,   0.8f,
    0.8f,   1.0f,   0.8f,   0.8f,   0.8f,   1.0f,
...
void reshape(int w, int h) {
  ...
  // TODO I still don't feel like I understnad how to move the frustum plane
  // Find an answer for this
  glUseProgram(theProgram);
  theMatrix[11] = h - 501;
  theMatrix[12] = abs(h - 501);
  theMatrix[13] = abs(h - 501);
  glUniformMatrix4fv(perspectiveMatrixUnif, 1, GL_FALSE, theMatrix);
  glUseProgram(0);
}
